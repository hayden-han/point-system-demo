...
class DataConsistencyTest extends IntegrationTestBase {
    ...
    class ConsistencyCases {
        ...
        void balanceConsistency_shouldMatch() {
            ...
            // WHEN
            long totalBalance = pointQueryRepository.getTotalBalance(memberId, now).getValue();
            ...
            // THEN
            assertThat(totalBalance).isEqualTo(1500L);
            assertThat(sumOfAvailable).isEqualTo(totalBalance);
        ...
        void ledgerConsistency_shouldMatch() {
            ...
            long usedAmount = ledger.earnedAmount() - ledger.availableAmount();
            assertThat(usedAmount).isEqualTo(500L);
            assertThat(ledger.earnedAmount())
                    .isEqualTo(ledger.availableAmount() + usedAmount);
        }
