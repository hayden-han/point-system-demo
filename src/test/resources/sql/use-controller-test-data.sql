...
VALUES (X'00000000000000000000000000008303', X'00000000000000000000000000008304', 'EARN', 3000, X'00000000000000000000000000008303', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO point_transaction (id, member_id, type, amount, ledger_id, transacted_at, created_at)
VALUES (X'00000000000000000000000000008304', X'00000000000000000000000000008305', 'EARN', 2000, X'00000000000000000000000000008304', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO point_transaction (id, member_id, type, amount, order_id, transacted_at, created_at)
VALUES (X'00000000000000000000000000008305', X'00000000000000000000000000008305', 'USE', 2000, 'ORDER-USE-CTRL-TEST', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
